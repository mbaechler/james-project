...
public class OpenJPAMailboxManager extends JPAMailboxManager {
    ...
    public OpenJPAMailboxManager(JPAMailboxSessionMapperFactory mapperFactory, Authenticator authenticator, 
            MailboxPathLocker locker, boolean useStreaming, MailboxACLResolver aclResolver, GroupMembershipResolver groupMembershipResolver,
    ...
    public OpenJPAMailboxManager(JPAMailboxSessionMapperFactory mapperFactory, Authenticator authenticator, 
            MailboxPathLocker locker,  String encryptPass, MailboxACLResolver aclResolver, GroupMembershipResolver groupMembershipResolver,
            DelegatingMailboxListener delegatingMailboxListener) {
        super(mapperFactory, authenticator,  locker, aclResolver, groupMembershipResolver, delegatingMailboxListener);
        if (encryptPass != null) {
    ...
    public OpenJPAMailboxManager(JPAMailboxSessionMapperFactory mapperFactory, Authenticator authenticator, 
            ...
            DelegatingMailboxListener delegatingMailboxListener) {
        this(mapperFactory, authenticator, new JVMMailboxPathLocker(), false, aclResolver, groupMembershipResolver, delegatingMailboxListener);
    }
