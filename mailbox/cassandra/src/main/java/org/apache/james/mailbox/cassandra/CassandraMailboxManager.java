...
/**
 * Cassandra implementation of {@link MailboxManager}
 */
public class CassandraMailboxManager implements MailboxManager {
    private static final Logger LOGGER = LoggerFactory.getLogger(CassandraMailboxManager.class);

    public static final EnumSet<MailboxManager.MailboxCapabilities> MAILBOX_CAPABILITIES = EnumSet.of(
    ...
    public CassandraMailboxManager(CassandraMailboxSessionMapperFactory mapperFactory, SessionProvider sessionProvider,
        ...
        this.mailboxSessionMapperFactory = mapperFactory;
    }
    ...
    public MessageManager getMailbox(MailboxId mailboxId, MailboxSession session) throws MailboxException {
        MailboxMapper mapper = mapperFactory.getMailboxMapper(session);
    ...
    public MessageManager getMailbox(MailboxPath mailboxPath, MailboxSession session) throws MailboxException {
        final MailboxMapper mapper = mapperFactory.getMailboxMapper(session);
