...
class MailboxPathV2MigrationTaskSerializationTest {
    ...
    private static final JsonTaskAdditionalInformationsSerializer JSON_TASK_ADDITIONAL_INFORMATIONS_SERIALIZER = JsonTaskAdditionalInformationsSerializer.of(MailboxPathV2MigrationTaskAdditionalInformationDTO.MODULE);
