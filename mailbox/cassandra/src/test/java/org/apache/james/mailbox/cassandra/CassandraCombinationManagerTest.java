...
public class CassandraCombinationManagerTest extends AbstractCombinationManagerTest {
    ...
    public CombinationManagerTestSystem createTestingData() throws Exception {
        return CassandraCombinationManagerTestSystem.createTestingData(cassandra.getCassandraCluster(), new NoQuotaManager(), MailboxEventDispatcher.ofListener(mock(MailboxListener.class)));
    }
