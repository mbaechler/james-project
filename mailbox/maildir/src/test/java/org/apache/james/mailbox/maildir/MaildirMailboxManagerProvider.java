...
public class MaildirMailboxManagerProvider {
    ...
    public static MaildirMailboxManager createMailboxManager(String configuration, File tempFile) {
        ...
        MaildirMailboxManager manager = new MaildirMailboxManager(mf, sessionProvider, messageParser, annotationManager, eventBus, storeRightManager, quotaComponents, index);

        return manager;
    }

    static class MaildirMailboxManager implements MailboxManager {
        private static final Logger LOGGER = LoggerFactory.getLogger(MaildirMailboxManager.class);
        ...
        public MaildirMailboxManager(MaildirMailboxSessionMapperFactory mf, SessionProviderImpl sessionProvider, MessageParser messageParser, StoreMailboxAnnotationManager annotationManager, InVMEventBus eventBus, StoreRightManager storeRightManager, QuotaComponents quotaComponents, MessageSearchIndex index) {
            this.mailboxSessionMapperFactory = mf;
            ...
            this.index = index;
            this.configuration = MailboxManagerConfiguration.DEFAULT;
            this.preDeletionHooks = PreDeletionHooks.NO_PRE_DELETION_HOOK;
        }
