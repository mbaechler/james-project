...
public abstract class MessageWithAttachmentMapperTest {
    ...
    public void setUp() throws Exception {
        ...
        assumeTrue(mapperProvider.getSupportedCapabilities().contains(MapperProvider.Capabilities.ATTACHMENT));
    ...
    @Test
    public void messagesRetrievedUsingFetchTypeFullShouldHaveAttachmentsLoadedWhenOneAttachment() throws Exception {
        saveMessages();
    ...
    @Test
    public void messagesRetrievedUsingFetchTypeFullShouldHaveAttachmentsLoadedWhenTwoAttachments() throws Exception {
        saveMessages();
        MessageMapper.FetchType fetchType = MessageMapper.FetchType.Full;
    ...
    @Test
    public void messagesRetrievedUsingFetchTypeBodyShouldHaveAttachmentsLoadedWhenOneAttachment() throws Exception {
        saveMessages();
    ...
    @Test
    public void messagesRetrievedUsingFetchTypeHeadersShouldHaveAttachmentsEmptyWhenOneAttachment() throws Exception {
        assumeTrue(mapperProvider.supportPartialAttachmentFetch());
        saveMessages();
    ...
    @Test
    public void messagesRetrievedUsingFetchTypeMetadataShouldHaveAttachmentsEmptyWhenOneAttachment() throws Exception {
        assumeTrue(mapperProvider.supportPartialAttachmentFetch());
        saveMessages();
    ...
    @Test
    public void messagesRetrievedUsingFetchTypeFullShouldHaveAttachmentsEmptyWhenNoAttachment() throws Exception {
        saveMessages();
        MessageMapper.FetchType fetchType = MessageMapper.FetchType.Full;
