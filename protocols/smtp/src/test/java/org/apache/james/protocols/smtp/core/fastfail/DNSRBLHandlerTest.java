...
public class DNSRBLHandlerTest {
    ...
    public void testBlackListedTextPresent() throws Exception {
        ...
        assertThat(mockedSMTPSession.getAttachment(RBL_DETAIL_MAIL_ATTRIBUTE_NAME, Connection)).withFailMessage("Details").isEqualTo("Blocked - see http://www.spamcop.net/bl.shtml?127.0.0.2");
