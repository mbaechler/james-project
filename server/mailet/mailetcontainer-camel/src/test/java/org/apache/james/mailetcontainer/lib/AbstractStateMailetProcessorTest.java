...
import static org.apache.mailet.Mail.DEFAULT;
import static org.apache.mailet.Mail.ERROR;
import static org.apache.mailet.Mail.GHOST;
import static org.apache.mailet.Mail.MAILET_ERROR_ATTRIBUTE_NAME;
...
public abstract class AbstractStateMailetProcessorTest {
    ...
    public void testSimpleRouting() throws Exception {
        ...
        assertThat(mail.getState()).isEqualTo(DEFAULT);
    ...
    public void matcherProcessingShouldCaptureExceptionAsMailAttributeWhenMatcherThrows() throws Exception {
        ...
        assertThat(mail.getAttribute(MAILET_ERROR_ATTRIBUTE_NAME).getClass()).isEqualTo(MessagingException.class);
        latch.await();
        processor.destroy();
    }
