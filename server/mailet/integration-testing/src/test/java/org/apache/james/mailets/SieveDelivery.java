...
public class SieveDelivery {
    ...
    public void simpleMailShouldBeSent() throws Exception {
        ...
        MailboxProbe mailboxProbe = jamesServer.getProbe(PojoMailboxProbe.class);
        ...
        jamesServer.getProbe(PojoSieveProbe.class).addActiveSieveScript(recipient, "myscript.sieve", "require \"fileinto\";\n" +
            "\n" +
