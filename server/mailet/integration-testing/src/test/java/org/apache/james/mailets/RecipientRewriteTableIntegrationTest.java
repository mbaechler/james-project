...
public class RecipientRewriteTableIntegrationTest {
    ...
    public void setup() throws Exception {
        ...
        dataProbe = jamesServer.getProbe(PojoDataProbe.class);
    ...
    private void createUserInbox(String username) throws Exception {
        ...
        jamesServer.getProbe(PojoMailboxProbe.class).createMailbox(MailboxConstants.USER_NAMESPACE, username, "INBOX");
    }
