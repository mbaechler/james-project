...
class SerialTaskManagerWorkerTest {
    ...
    void aRunningTaskShouldProvideInformationUpdatesDuringExecution() throws InterruptedException {
        ...
        verify(listener, atLeastOnce()).updated(eq(taskWithId.getId()), eq(taskWithId.getTask().type()), notNull());
    }
    ...
    void aRunningTaskShouldHaveAFiniteNumberOfInformation() throws InterruptedException {
        ...
        verify(listener, atMost(2)).updated(eq(taskWithId.getId()), eq(taskWithId.getTask().type()), notNull());
    }
    ...
    void aRunningTaskShouldEmitAtMostOneInformationPerSecond() {
        ...
        verify(listener, times(2)).updated(eq(taskWithId.getId()), eq(taskWithId.getTask().type()), notNull());
    }
