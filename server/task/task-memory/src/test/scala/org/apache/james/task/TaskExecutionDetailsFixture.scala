...
object TaskExecutionDetailsFixture {
  ...
  val ADDITIONAL_INFORMATION: () => Optional[AdditionalInformation] = () => Optional.of(new MemoryReferenceWithCounterTask.AdditionalInformation(5, Clock.systemUTC().instant()))
