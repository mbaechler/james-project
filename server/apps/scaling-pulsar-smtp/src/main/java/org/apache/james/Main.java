...
public class Main implements JamesServerMain {
    ...
    public static final Module SERVER_CORE_MODULES = Modules.combine(
            ...
            new CassandraSessionModule(),// to remove
            ...
            new CassandraDomainListModule(), // JPA/PG
            new CassandraRecipientRewriteTableModule(), // JPA/PG
            new CassandraUsersRepositoryModule(), // JPA/PG
            new CassandraMetricsModule(), // => useless
