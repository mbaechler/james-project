...
class BlobStoreCacheModulesChooserTest {
    ...
    void chooseModulesShouldReturnCacheDisabledModuleWhenCacheDisabled() {
        assertThat(BlobStoreCacheModulesChooser.chooseModules(BlobStoreConfiguration.builder().objectStorage().disableCache()))
            .hasSize(1)
            .first()
    ...
    void chooseModulesShouldReturnCacheEnabledAndCassandraCacheModulesWhenCacheEnabled() {
        assertThat(BlobStoreCacheModulesChooser.chooseModules(BlobStoreConfiguration.builder().objectStorage().enableCache()))
            .hasSize(2)
            .allSatisfy(module ->
