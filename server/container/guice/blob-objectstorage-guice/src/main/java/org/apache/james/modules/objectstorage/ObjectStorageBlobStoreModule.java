...
public class ObjectStorageBlobStoreModule extends AbstractModule {
    ...
    protected void configure() {
        //bind(BlobStore.class).toProvider(ObjectStorageBlobsDAO.class);
    }

    @Provides
    @Singleton
    private PayloadCodec buildPayloadCoder(ObjectStorageBlobConfiguration configuration) {
    ...
    private ObjectStorageBlobsDAO buildObjectStore(ObjectStorageBlobConfiguration configuration, BlobId.Factory blobIdFactory) {
        return selectDaoBuilder(configuration)
            ...
            .blobIdFactory(blobIdFactory).build();
    }
