...
class DeleteMailsFromMailQueueTaskTest {
    ...
    private JsonTaskAdditionalInformationsSerializer jsonAdditionalInformationsSerializer = JsonTaskAdditionalInformationsSerializer.of(DeleteMailsFromMailQueueTaskAdditionalInformationDTO.MODULE);
