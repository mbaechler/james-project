...
class DeleteMailsFromMailQueueTaskTest {
    ...
    void taskShouldThrowWhenDeserializeAnUnknownQueue() throws Exception {
        ...
        String serializedJson = "{\"type\": \"delete-mails-from-mail-queue\", \"queue\": \"anyQueue\", \"sender\": \"a@b.c\", \"timestamp\": \"2018-11-13T12:00:55Z\"}";
    ...
    void taskShouldThrowWhenDeserializeAMalformedMailAddress() throws Exception {
        ...
        String serializedJson = "{\"type\": \"delete-mails-from-mail-queue\", \"queue\": \"" + queueName + "\", \"sender\": \"a.b.c\", \"timestamp\": \"2018-11-13T12:00:55Z\"}";
        assertThatThrownBy(() -> testee.deserialize(serializedJson))
    ...
    private static Stream<Arguments> validAdditionalInformations() throws Exception {
        return Stream.of(
            Arguments.of(10L, 5L, Optional.of(new MailAddress("a@b.c")), Optional.empty(), Optional.empty(), "{\"queue\": \"anyQueue\", \"sender\": \"a@b.c\", \"initialCount\" : 10, \"remainingCount\":5, \"timestamp\": \"2018-11-13T12:00:55Z\"}"),
            Arguments.of(1L, 0L, Optional.empty(), Optional.of("name"), Optional.empty(), "{\"queue\": \"anyQueue\", \"name\": \"name\", \"initialCount\" : 1, \"remainingCount\":0, \"timestamp\": \"2018-11-13T12:00:55Z\"}"),
            Arguments.of(6L, 6L, Optional.empty(), Optional.empty(), Optional.of(new MailAddress("d@e.f")), "{\"queue\": \"anyQueue\", \"recipient\": \"d@e.f\", \"initialCount\" : 6, \"remainingCount\":6, \"timestamp\": \"2018-11-13T12:00:55Z\"}")
        );
    }
