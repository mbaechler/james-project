...
class DeletedMessagesVaultExportTaskSerializationTest {
    ...
    private static final JsonTaskAdditionalInformationsSerializer JSON_TASK_ADDITIONAL_INFORMATIONS_SERIALIZER = JsonTaskAdditionalInformationsSerializer.of(DeletedMessagesVaultExportTaskAdditionalInformationDTO.MODULE);
