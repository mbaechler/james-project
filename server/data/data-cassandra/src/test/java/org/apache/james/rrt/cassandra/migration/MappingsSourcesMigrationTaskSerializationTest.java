...
class MappingsSourcesMigrationTaskSerializationTest {
    ...
    private static final JsonGenericSerializer<MappingsSourcesMigration.AdditionalInformation, MappingsSourcesMigrationTaskAdditionalInformationDTO> JSON_TASK_ADDITIONAL_INFORMATION_SERIALIZER = JsonGenericSerializer
        .forModules(MappingsSourcesMigrationTaskAdditionalInformationDTO.serializationModule(MappingsSourcesMigration.TYPE))
        .withoutNestedType();
